...
class Line():
	...
	def getCoverPoints(self):
		if self.a.x == self.b.x:
			...
			return [Point(self.a.x, i) for i in range(self.a.y, self.b.y + step, step)]
		if self.a.y == self.b.y:
			step = -1 if self.a.x > self.b.x else  1
			return [Point(i, self.a.y) for i in range(self.a.x, self.b.x + step, step)]
